...
EOF
    ...
    echo -e "${BrightYellow}* Copyright ©MJC, 2024\033[0m"
    echo -e "${BrightYellow}* GitHub: https://github.com/mjoeyx\033[0m\n"
}
...
scrape_function() {
    ...
    rm temp_file.txt
    if [[ -f "MJC_email_output.txt" || -f "MJC_phone_output.txt" || -f "MJC_social_media_output.txt" ]]; then
        sleep 0.4
